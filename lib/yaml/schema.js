...
import { _defineProperty, defaultTagPrefix, defaultTags } from './plainvalue.js';
import { YAMLMap, resolveMap, YAMLSeq, resolveSeq as _resolveSeq, resolveString, stringifyString, strOptions, intOptions, stringifyNumber, Scalar, nullOptions, boolOptions, Node, Alias, Pair } from './resolveseq.js';
import { binary as _binary, omap as _omap, pairs as _pairs, set as _set, intTime as _intTime, floatTime as _floatTime, timestamp as _timestamp, warnOptionDeprecation } from './warnings.js';
...
const yaml11 = failsafe.concat([{
  ...
  stringify: stringifyNumber
}], _binary, _omap, _pairs, _set, _intTime, _floatTime, _timestamp);
