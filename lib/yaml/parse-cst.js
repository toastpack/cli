...
import { Node, Type, Range, YAMLSemanticError, YAMLSyntaxError, Char, PlainValue as _PlainValue, _defineProperty } from './plainvalue.js';
...
function createNewNode(type, props) {
  switch (type) {
    ...
    case Type.COMMENT:
    case Type.PLAIN:
      return new _PlainValue(type, props);
